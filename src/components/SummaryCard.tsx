    ...
    return (
      <div className="summary-card cobrador-hoy-card" onClick={onClick} style={{ cursor: onClick ? 'pointer' : 'default' }}>
        <div className="cobrado-hoy-header">
          <span className="cobrado-hoy-icon">👥</span>
          <span className="cobrado-hoy-title">Clientes con abono</span>
        </div>
        <div className="cobrado-hoy-value" style={{ color: accentColor, fontWeight: 700, fontSize: 32, marginTop: 6, marginBottom: 2, letterSpacing: '-1px', textAlign: 'left' }}>{value}</div>
        <div className="cobrado-hoy-bg">
          <svg width="100%" height="40" viewBox="0 0 200 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 30 Q 50 10 100 30 T 200 30 V40 H0Z" fill="#7C3AED11" />
            <path d="M0 35 Q 50 20 100 35 T 200 35" stroke="#7C3AED22" strokeWidth="2" fill="none" />
          </svg>
        </div>
      </div>
    );
  ...
  if (title === "Clientes nuevos") {
    return (
      <div className="summary-card cobrador-hoy-card" onClick={onClick} style={{ cursor: onClick ? 'pointer' : 'default' }}>
        <div className="cobrado-hoy-header">
          <span className="cobrado-hoy-icon">🆕</span>
          <span className="cobrado-hoy-title">Clientes nuevos</span>
        </div>
        <div className="cobrado-hoy-value" style={{ color: accentColor, fontWeight: 700, fontSize: 28, marginTop: 6, marginBottom: 2, letterSpacing: '-1px', textAlign: 'left' }}>{value}</div>
        <div className="cobrado-hoy-bg">
          <svg width="100%" height="40" viewBox="0 0 200 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 30 Q 50 10 100 30 T 200 30 V40 H0Z" fill="#6366F111" />
            <path d="M0 35 Q 50 20 100 35 T 200 35" stroke="#6366F122" strokeWidth="2" fill="none" />
          </svg>
        </div>
      </div>
    );
  ...
  if (title === "Total por cobrar") {
    return (
      <div className="summary-card cobrador-hoy-card" onClick={onClick} style={{ cursor: onClick ? 'pointer' : 'default' }}>
        <div className="cobrado-hoy-header">
          <span className="cobrado-hoy-icon">💰</span>
          <span className="cobrado-hoy-title">Total por cobrar</span>
        </div>
        <div className="cobrado-hoy-value" style={{ color: accentColor, fontWeight: 700, fontSize: 28, marginTop: 6, marginBottom: 2, letterSpacing: '-1px', textAlign: 'left' }}>{value}</div>
        <div className="cobrado-hoy-bg">
          <svg width="100%" height="40" viewBox="0 0 200 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 30 Q 50 10 100 30 T 200 30 V40 H0Z" fill="#4CAF7A11" />
            <path d="M0 35 Q 50 20 100 35 T 200 35" stroke="#4CAF7A22" strokeWidth="2" fill="none" />
          </svg>
        </div>
      </div>
    );
