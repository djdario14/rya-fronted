...
const ClientesPage: React.FC = () => {
  ...
  return (
    <div style={{ background: '#f7f8fa', minHeight: '100vh', padding: 32, fontFamily: 'Inter, sans-serif' }}>
      <div style={{ background: '#fff', borderRadius: 18, boxShadow: '0 8px 32px #0002', width: 700, maxWidth: '100%', padding: 36, border: '1px solid #f0f0f0', position: 'relative', margin: '0 auto' }}>
        {/* Botón Volver */}
        ...
        {/* Cierre correcto de todos los divs principales */}
      </div>
    </div>
  );
};
